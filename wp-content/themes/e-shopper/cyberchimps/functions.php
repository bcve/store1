...
function cyberchimps_addon_sections( $sections_list ) {
	$sections_list[] = array(
		...
		'label'   => __( 'The Events Calendar', 'e-shopper' ),
		'heading' => 'cyberchimps_addons_heading'
	);

	$sections_list[] = array(
		'id'      => 'cyberchimps_digital_downloads_options',
		'label'   => __( 'Digital Downloads', 'e-shopper' ),
		'heading' => 'cyberchimps_addons_heading'
	);
...
function cyberchimps_addon_fields( $fields_list ) {
	...
	$fields_list[] = array(
		'name'     => __( 'Digital Downloads', 'e-shopper' ),
...
function cyberchimps_custom_events_callback( $value ) {
	...
	if( isset( $installed_plugins[$plugin] ) ) {
		if( is_plugin_active( $plugin ) ) {
			$output .= $icon . '<a href="' . admin_url( 'edit.php?post_type=tribe_events&page=tribe-events-calendar' ) . '">' . __( 'Events Plugin Options', 'e-shopper' ) . '</a>';
		}
		else {
			$output .= $icon_neg . '<a href="' . admin_url( 'plugins.php' ) . '">' . __( 'Please activate The Events Calendar plugin', 'e-shopper' ) . '</a>';
		}
	}
	else {
		$output .= $icon_neg . '<a href="' . cyberchimps_eventcal_install_link() . '">' . __( 'Install Events Calendar Plugin', 'e-shopper' ) . '</a>';
	}
...
function cyberchimps_digital_downloads_callback( $value ) {
	...
	if( isset( $installed_plugins[$plugin] ) ) {
		if( is_plugin_active( $plugin ) ) {
			$output .= $icon . '<a href="' . admin_url( 'edit.php?post_type=download&page=edd-settings' ) . '">' . __( 'Digital Downloads Settings', 'e-shopper' ) . '</a>';
		}
		else {
			$output .= $icon_neg . '<a href="' . admin_url( 'plugins.php' ) . '">' . __( 'Please activate Easy Digital Downloads plugin', 'e-shopper' ) . '</a>';
		}
	}
	else {
		$output .= $icon_neg . '<a href="' . cyberchimps_digital_downloads_install_link() . '">' . __( 'Install Easy Digital Downloads Plugin', 'e-shopper' ) . '</a>';
	}
